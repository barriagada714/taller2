...
public class Reporte extends JFrame{
    ...
    public Reporte(Home h) {
        super("Reportes");
        
        
        imprimirButton = new JButton("Imprimir");
        
         imprimirButton.addActionListener((java.awt.event.ActionEvent evt) -> {
            accionBotonImprimirRegistro(evt);
        });
        ...
        cerrarButton = new JButton("Cerrar");
         ...
         obtenerButton.addActionListener((java.awt.event.ActionEvent evt) -> {
            accionBotonObtener(evt);
        });
    ...
    private void accionBotonImprimirRegistro(ActionEvent evt){
    
    
    }
    
    private void accionBotonCerrar(ActionEvent evt) {
        
    }
    
    
    private void accionBotonObtener(ActionEvent evt) {
